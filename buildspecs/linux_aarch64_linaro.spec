...
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_aarch64_linaro">
	<name>Linux AARCH64</name>
	<asmBuilderName>ARMGNUEABI</asmBuilderName> <!-- XXX change this? -->
	<cpuArchitecture>AARCH64</cpuArchitecture>
	<os>linux</os>
	...
	<properties>
		...
		<property name="aotTarget" value="ia64-linux"/>
		...
		<property name="graph_label.java5" value="j9vmxr6424"/>
		<property name="graph_label.java6" value="pxr6460"/>
		...
		<property name="graph_label.java7_raw" value="jdk7-linux-aarch64"/>
		<property name="graph_label.java8" value="pxr6480"/>
		<property name="graph_label.java8_raw" value="jdk8-linux-aarch64"/>
		...
		<property name="graph_property.linux_2.4.graph_req.machine.test" value="{$machine_mapping.aarch64$}"/>
		...
		<property name="graph_property.linux_2.6.graph_req.machine.test" value="{$machine_mapping.aarch64$}"/>
		...
		<property name="graph_req.machine" value="{$machine_mapping.aarch64$}"/>
		...
		<property name="uma_make_cmd_cxx" value="$(OPENJ9_CC_PREFIX)-c++"/>
	...
	<flags>
		...
		<flag id="interp_aotCompileSupport" value="false"/>
		<flag id="interp_aotRuntimeSupport" value="false"/>
		<flag id="interp_debugSupport" value="true"/>
		<flag id="interp_enableJitOnDesktop" value="false"/>
